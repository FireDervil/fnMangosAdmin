...
class MangosDatabase //MySQL
{
  ...
  function db($db_name)
  {
    ...
    {
        $sql = mysql_query($query,$this->link_id) or die("Couldnt Run Query: ".$query."<br />Error: ".mysql_error($this->link_id)."");
...
// selectCell returns 1 cell of data, Not recomended unless you want data from a specific cell in a table
 ...
 /**
    ...
    */
    ...
    {
        @mysql_query($query,$this->link_id) or die(mysql_error());
        $this->sqlog .= $query."\n";
    }
    ...
    */
    ...
    {
        $sql = @mysql_query($query,$this->link_id) or die(mysql_error());
        $this->sqlog .= $query."\n";
        return $sql;
    }
 ...
 public function select($query)
    {
        $sql = mysql_query($query, $this->link_id) or die("Couldnt Run Query: ".$query."<br />Error: ".$this->error($this->link_id)."");
		$this->_statistics['count']++;
		$i = 1;
		...
		{
			while($row = $this->fetch_assoc($sql))
			{
	...
	public function mysql_count($query)
    {
        $sql = mysql_query($query, $this->link_id) or die("Couldnt Run Query: ".$query."<br />Error: ".mysql_error($this->link_id)."");
		$this->_statistics['count']++;
