...
class Zone
{
	...
	{
		$this->construct_zones();
	}
	
	public function getZoneName($id)
	{
        if(isset($this->zoneById[$id]))
		{
            $zonename = $this->zoneById[$id];
        }
		else
		{
	...
	// Taken from POMM :p ... Thank god i didnt have to type all this
	function construct_zones()
	{
		$this->zoneById = array(
			1 => 'Dun Morogh',
			2 => 'Longshore',
